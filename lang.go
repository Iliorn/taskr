...
var daTranslations = map[string]string{
	...
	"Momentum":                           "Momentum",
	"Total":                              "I alt",
	"#%d of %d by sequence · score %.1f": "#%d af %d efter sekvens · score %.1f",
	"score %.1f · not in the ranking (subtasks rank with their parent)":    "score %.1f · uden for rangeringen (delopgaver rangerer med deres forælder)",
	...
	"%.1f short of #%d %s":                                     "%.1f fra at overhale #%d %s",
	"%.1f clear of #%d %s":                                     "%.1f foran #%d %s",
...
var deTranslations = map[string]string{
	...
	"Momentum":                           "Momentum",
	"Total":                              "Gesamt",
	"#%d of %d by sequence · score %.1f": "#%d von %d nach Sequenz · Punkte %.1f",
	"score %.1f · not in the ranking (subtasks rank with their parent)":    "Punkte %.1f · nicht in der Rangliste (Teilaufgaben zählen bei ihrer Hauptaufgabe)",
	...
	"%.1f short of #%d %s":                                     "%.1f fehlen zu #%d %s",
	"%.1f clear of #%d %s":                                     "%.1f Vorsprung vor #%d %s",
