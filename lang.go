...
var daTranslations = map[string]string{
	...
	"  Nothing open in this project.":  "  Intet åbent i dette projekt.",
	...
	"  done per week, last %d: ":                                       "  færdige pr. uge, sidste %d: ",
...
var deTranslations = map[string]string{
	...
	"  Nothing open in this project.":  "  In diesem Projekt ist nichts offen.",
	...
	"  done per week, last %d: ":                                       "  fertig pro Woche, letzte %d: ",
